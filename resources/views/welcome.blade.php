...
<div class="navbar-wrapper">
        <nav class="navbar navbar-default navbar-fixed-top navbar-expand-md" role="navigation">
            <div class="container">
                <a class="navbar-brand" href="index.html">WEBAPP</a>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="{{asset('backend/img/landing/perspective.png')}}" alt="dashboard" class="img-fluid">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="{{asset('backend/img/landing/dashboard.png')}}" alt="dashboard" class="img-fluid float-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="{{asset('backend/img/landing/avatar3.jpg')}}" class="img-fluid rounded-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="{{asset('backend/img/landing/avatar1.jpg')}}" class="img-fluid rounded-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="{{asset('backend/img/landing/avatar2.jpg')}}" class="img-fluid rounded-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="{{asset('backend/img/landing/iphone.jpg')}}" class="img-fluid" alt="dashboard">
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="float-left">
                        <img alt="image" src="{{asset('backend/img/landing/avatar3.jpg')}}">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="float-left">
                        <img alt="image" src="{{asset('backend/img/landing/avatar1.jpg')}}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="float-left">
                        <img alt="image" src="{{asset('backend/img/landing/avatar2.jpg')}}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
...
<a href="#" class="chatbox-btn" id="btnShoChat">
  ...
  <div class="form-container">
    <div class="main-card card">
      <div class="card-header">
        <span class="user chatbox-title" id=""> Admin</span>
        <button class="btn btn-sm btn-default float-right chatbot-close-btn"><i class="fa fa-times"></i></button>

      </div>
      <div class="card-body p-2">
        <form action="" class="">

          <label for="msg" class=""><b>Name</b></label>
          <input placeholder="Enter Your Name" name="name" id="name" class="form-control" type="text" required>
          <br>


          <label for="msg" class=""><b>Message</b></label>
          <textarea placeholder="Type message.." name="msg" id="msg" required></textarea>

          <button type="submit" id="btnSend" class="btn btn-primary btn-block">Send</button>
...
<script src="{{asset('backend/js/plugins/wow/wow.min.js')}}"></script>
